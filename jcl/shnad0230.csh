...
#   ファイル削除処理
#------------------------------------------------------------------------#
rm -f $WKDIR/hnt225p_001.dat
#
#------------------------------------------------------------------------#
#   ファイル受信
#------------------------------------------------------------------------#
#20251117 LMDC移行
#set F_FILE="$FTPASSTYPE.MST225P.001"
#set D_FILE="$WKDIR/hnt225p_001.dat"
#set N_NO="1"
##
...
set F_FILE    =  ${IFTYPE}HN-AD00-MST225P001     # 論理ファイル名
set D_FILE    =  $WKDIR/hnt225p_001.dat          # 取出し後ファイル名
#
...
#   ファイル権限変更
#------------------------------------------------------------------------#
chmod 666 $WKDIR/hnt225p_001.dat
#
#------------------------------------------------------------------------#
#   DATE出力
#------------------------------------------------------------------------#
