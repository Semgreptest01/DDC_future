...
#------------------------------------------------------------------------#
#   PLSQL ( hnawpl470.sql )  計画終了対象商品週次リラン用削除
#------------------------------------------------------------------------#
set JN_SQL = $PLSQLDIR/hnawpl470.sql
...
#------------------------------------------------------------------------#
#   PLSQL ( hnawpl480.sql )  計画終了対象商品週次作成
#------------------------------------------------------------------------#
set JN_SQL = $PLSQLDIR/hnawpl480.sql
set SQL_NAME = sqlplus
set SQL_PARM = "-s $ORAUID/$ORAPWD @$JN_SQL"
set CHECKFILE=$JN_SQL
source $SUBSRCDIR/filechk.src
...
#------------------------------------------------------------------------#
# ANALYZE HNT_計画終了対象商品_週次
#------------------------------------------------------------------------#
set DDL_FILE    = $SQLDIR/hnt033_alz_tbl_${ORAUID}.sql
set SQL_NAME    = sqlplus
