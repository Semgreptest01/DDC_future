...
# 修正履歴      : 
# NO  修正日付     修正者      修正内容
#  1  2025/11/17   K.Takashima LMDC移行対応：ftpass=>IFP
...
#   ファイル削除処理
#------------------------------------------------------------------------#
rm -f $WKDIR/hnt229p_001.dat
#
#LMDC移行##------------------------------------------------------------------------#
#LMDC移行##   ファイル受信
#LMDC移行##------------------------------------------------------------------------#
#LMDC移行#set F_FILE="$FTPASSTYPE.MST229P.001"
#LMDC移行#set D_FILE="$WKDIR/hnt229p_001.dat"
#LMDC移行#set N_NO="1"
#LMDC移行##
...
set F_FILE    =  ${IFTYPE}HN-AD00-MST229P001     # 論理ファイル名
set D_FILE    =  $WKDIR/hnt229p_001.dat            # 取出し後ファイル名
#
...
#   ファイル権限変更
#------------------------------------------------------------------------#
chmod 666 $WKDIR/hnt229p_001.dat
#
#------------------------------------------------------------------------#
#   DATE出力
#------------------------------------------------------------------------#
