...
#   ファイル削除処理
#------------------------------------------------------------------------#
rm -f $WKDIR/hnt204p_001.csv
#
#------------------------------------------------------------------------#
#      IFP集信ファイル取出し部
#------------------------------------------------------------------------#
set BAKRECV_DIR = $BKUPDIR # 集信ファイルのバックアップ先
set F_FILE    =  ${IFTYPE}HN-AD00-MST204P001     # 論理ファイル名
set D_FILE    =  $WKDIR/hnt204p_001.csv            # 取出し後ファイル名
#
...
#   ファイル権限変更
#------------------------------------------------------------------------#
chmod 666 $WKDIR/hnt204p_001.csv
#
#------------------------------------------------------------------------#
#   DATE出力
#------------------------------------------------------------------------#
