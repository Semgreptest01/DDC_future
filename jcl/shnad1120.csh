...
# JOB-名        : 受信ファイル取出し(HNM_セキュリティ取引相手先)
# Shell-名      : shnad1120.csh
# 機能          : １．ＪＯＢ出力ファイル削除
#               : ２．IFP集信ファイル取出し部
# 作成者        : M.Yamamoto
# 作成日        : 2025/12/02
...
#      １．ＪＯＢ出力ファイル削除
#------------------------------------------------------------------------#
echo "rm -f $WKDIR/hnt402p_001.dat" | tee -a $LOG_FILE
rm $WKDIR/hnt402p_001.dat

#------------------------------------------------------------------------#
#     ２．IFP集信ファイル取出し部
#------------------------------------------------------------------------#
set BAKRECV_DIR = $BKUPDIR                     # 集信ファイルのバックアップ先
set F_FILE      = ${IFTYPE}HN-AD00-SMM102P001  # 論理ファイル名
set D_FILE      = $WKDIR/hnt402p_001.dat       # 取出し後ファイル名
#
...
#   ファイル権限変更
#------------------------------------------------------------------------#
chmod 666 $WKDIR/hnt402p_001.dat
